...
export const metricCatalog: (typeof schema.metricDefinitions.$inferInsert)[] = [
  {
    key: "weight",
    label: "Vægt",
    unit: "kg",
...
export const exerciseCatalog: {
  ...
  { name: "Barbell Back Squat", muscleGroup: "quad", equipment: "barbell" },
  { name: "Barbell Front Squat", muscleGroup: "quad", equipment: "barbell" },
  { name: "Goblet Squat", muscleGroup: "quad", equipment: "dumbbell" },
  { name: "Bulgarian Split Squat", muscleGroup: "quad", equipment: "dumbbell" },
  { name: "Leg Press", muscleGroup: "quad", equipment: "machine" },
  { name: "Romanian Deadlift", muscleGroup: "hamstring", equipment: "barbell" },
  { name: "Conventional Deadlift", muscleGroup: "hamstring", equipment: "barbell" },
  { name: "Hip Thrust", muscleGroup: "glutes", equipment: "barbell" },
  { name: "Glute Bridge", muscleGroup: "glutes", equipment: "bodyweight" },
  { name: "Walking Lunge", muscleGroup: "quad", equipment: "dumbbell" },
...
export async function seedCatalog(db: NeonHttpDatabase<typeof schema>) {
